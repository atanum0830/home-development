	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="curMonth">Current Month</g:link></li>
				<li><g:link class="list" action="nextMonth">Next Month</g:link></li>
				<li><g:link class="list" action="prevMonth">Prev Month</g:link></li>
				<li><g:link class="list" action="unpaid">Unpaid</g:link></li>
				<li><g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
				<!--
				<li><g:link class="list" action="month"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
				-->
